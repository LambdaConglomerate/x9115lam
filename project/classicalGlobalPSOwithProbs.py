...
"""
This implementation with keep a probability array that will hold the 
success probabilities for selecting the best to interpolate for the
current probs.  
"""
def classicalGlobalPSOProbs(model, retries, changes, goal = 0.01, pat = 100, era = 100, np=30, phi_1=2.8, phi_2=1.3, inertia=0.8):
    emin = 0
